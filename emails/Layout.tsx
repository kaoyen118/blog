          ...
          <Container className="mx-auto mt-[32px] w-[465px]">
            ...
            <Section>
              ...
              <Text className="text-center">
                <Link
                  href="https://blog-xi-lovat-96.vercel.app/"
              ...
              <Text className="text-center">
                <Link
                  href="https://blog-xi-lovat-96.vercel.app//twitter"
                ...
                |&nbsp;
                <Link
                  href="https://blog-xi-lovat-96.vercel.app//youtube"
                  className="text-xs text-zinc-600 underline"
                >
                  YouTube
                </Link>{' '}
                |&nbsp;
                <Link
                  href="https://blog-xi-lovat-96.vercel.app//github"
                  className="text-xs text-zinc-600 underline"
                >
                  GitHub
                </Link>{' '}
                |&nbsp;
                <Link
                  href="https://blog-xi-lovat-96.vercel.app//bilibili"
                  className="text-xs text-zinc-600 underline"
                >
                  哔哩哔哩
                </Link>
